...
| `fundamentals` | 每日指标（PE/PB/换手率/市值） | 行情数据 | PRO | [查看](endpoints/fundamentals.md) |
| `adj_factor` | 复权因子 | 行情数据 | PRO | [查看](endpoints/adj-factor.md) |
...
| `nav` | ETF 净值 | ETF | PRO | [查看](endpoints/nav.md) |
| `portfolio` | ETF 持仓明细 | ETF | PRO | [查看](endpoints/portfolio.md) |
| `share_size` | ETF 份额与规模 | ETF | PRO | [查看](endpoints/share-size.md) |
| `tracking_indices` | ETF 跟踪指数基础信息 | ETF | PRO | [查看](endpoints/tracking-indices.md) |
...
| `income` | 利润表 | 财务数据 | PRO | [查看](endpoints/income.md) |
| `balance_sheet` | 资产负债表 | 财务数据 | PRO | [查看](endpoints/balance-sheet.md) |
| `cash_flow` | 现金流量表 | 财务数据 | PRO | [查看](endpoints/cash-flow.md) |
| `forecast` | 业绩预告 | 财务数据 | PRO | [查看](endpoints/forecast.md) |
| `express` | 业绩快报 | 财务数据 | PRO | [查看](endpoints/express.md) |
...
| `dividend` | 分红送股 | 分红送股 | PRO | [查看](endpoints/dividend.md) |
...
| `realtime` | 实时行情快照 | 实时与快讯 | PRO | [查看](endpoints/realtime.md) |
| `news_flash` | 财经快讯（实时） | 实时与快讯 | PRO | [查看](endpoints/news-flash.md) |
